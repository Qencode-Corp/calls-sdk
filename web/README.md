...
place, and reports call quality. It ships no screens and no theme. Version 0.1.0, pre-release.
...
| `setLatencyMode('lowest' \| 'smooth')` | Jitter buffer target, degradation preference and audio framing in one switch. |
